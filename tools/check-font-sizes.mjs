// 字号守门（照 WPE x64 的 WebUI/tools/check-font-sizes.mjs 抄过来，只换了白名单）：
// src 下所有 .vue / .css 的 font-size 只许用 var(--fs-*)（或四个语义别名 / inherit），
// 写死 px 的只允许下面这张白名单里的例外。改完样式跑一次：
//   node tools/check-font-sizes.mjs
// 有违规就 exit 1。九级令牌定义在 src/tokens.css，与 WPE 逐字相同 —— 改层级要两边一起改。
