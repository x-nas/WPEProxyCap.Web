...
export const DICT = {
  ...
  'mob.obStep': { zh: '第 {0} 步，共 2 步', en: 'Step {0} of 2' },
  ...
  'mob.obNext': { zh: '下一步：登录账号', en: 'Next: sign in' },
  'mob.obAccTitle': { zh: '登录账号', en: 'Sign in' },
  'mob.obAccDesc': { zh: '账号密码由代理服务器的管理员提供，只保存在这台手机上。', en: 'Your account and password come from the proxy server administrator and are stored only on this phone.' },
  'mob.obDone': { zh: '完成', en: 'Done' },
  'mob.obBack': { zh: '上一步', en: 'Back' },
  ...
  'mob.noAccount': { zh: '未填写', en: 'Not set' },
